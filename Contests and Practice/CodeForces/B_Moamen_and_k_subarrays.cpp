...
//if stuck, try building the solution from end to beginning (stamping sequence, burst balloons, etc)
//check overflow, if a variable is of 10**9 order, use long long only.
