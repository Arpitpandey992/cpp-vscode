...
int n, m;
int a[51][51];
void dfs(int i, int j, vector<vector<bool>>& vis, int ct) {
    vis[i][j] = true;
    if (i > 0)
...
bool chk() {
    ...
    if (v[0].ff == v[1].ff + 1 && v[0].ss == v[1].ss) return true;
    if (v[0].ff == v[1].ff && v[0].ss == v[1].ss + 1) return true;
    if (v[0].ff + 1 == v[1].ff && v[0].ss == v[1].ss) return true;
    if (v[0].ff == v[1].ff && v[0].ss + 1 == v[1].ss) return true;
    return false;
}
int main() {
    fastio;
