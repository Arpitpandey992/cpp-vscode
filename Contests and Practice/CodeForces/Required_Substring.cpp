...
void solve() {
    ...
    // ans = total strings (n^26) - those strings which dont contain pattern anywhere
    // DP[i][j] = number of substrings ending at i and which match the pattern till j places
