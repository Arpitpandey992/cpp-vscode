...
#pragma endregion
//-------------------------------------------------------------------------------//
vector<pair<int, int>> m1 = {{-1, 0}, {1, 0}, {0, 1}, {0, -1}};
map<char, int> m2 = {{'N', 0}, {'S', 1}, {'E', 2}, {'W', 3}};
int n, m;

bool can(int x, int y, int k, vpii &ins, vector<vector<char>> &a, vector<vvi> &DP) {
    ...
    if (DP[x][y][dir] < del)
        return false;
    return can(x + dx, y + dy, k + 1, ins, a, DP);
}
