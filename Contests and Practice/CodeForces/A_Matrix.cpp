...
#include <vector>
using namespace std;
const long long M = 1000000007;  //Change it when needed, used in modadd,..
const long long M2 = 998244353;
const long long M3 = 1000000009;
const int INF = INT32_MAX;
#define modadd(x, y) (((((x % M) + (y % M)) % M) + M) % M)
